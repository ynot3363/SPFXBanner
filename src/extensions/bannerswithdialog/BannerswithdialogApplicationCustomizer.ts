...
const LOG_SOURCE: string = 'BannerswithdialogApplicationCustomizer';
 ...
 */
export interface IBannerswithdialogApplicationCustomizerProperties {
  // This is an example; replace with your own property
  testMessage: string;
}

/** A Custom Action which can be run during execution of a Client Side Application */
export default class BannerswithdialogApplicationCustomizer
  extends BaseApplicationCustomizer<IBannerswithdialogApplicationCustomizerProperties> {
  ...
  private _updateData(): void {
    ...
    let placeholderlink: string = '<a href="#" id="spce_btnLastReviewed" alt="Set page as reviewed">';
    ...
    let lastReviewedElement: HTMLElement = document.getElementById('spce_btnLastReviewed');
  ...
  private _clickeventhandler(): void {
    ...
    let thisElement: HTMLElement = document.getElementById('spce_btnLastReviewed');
    ...
    try {
      ...
      dialog.show().then(() => {
        Log.info(LOG_SOURCE,`Message from Custom Dialog --> ` + dialog.paramFromDialog);
      });
    }
    catch (error) {
